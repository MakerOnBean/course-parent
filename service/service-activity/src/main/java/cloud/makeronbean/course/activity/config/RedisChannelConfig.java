...
import cloud.makeronbean.course.activity.receiver.MessageReceive;
...
public class RedisChannelConfig {
    ...
    public RedisMessageListenerContainer container(RedisConnectionFactory redisConnectionFactory,
        ...
        // 设置消息适监听，并订阅主题
        redisMessageListenerContainer.addMessageListener(messageListenerAdapter,new PatternTopic(RedisConst.STATE_TOPIC));
    ...
    public MessageListenerAdapter messageListenerAdapter(MessageReceive receive) {
        // 参数一为消息接收对象
        // 参数二为接收对象的消息处理方法
        return new MessageListenerAdapter(receive,RedisConst.STATE_RECEIVER_METHOD);
    }
