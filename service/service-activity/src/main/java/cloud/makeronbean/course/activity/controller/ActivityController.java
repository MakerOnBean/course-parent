...
public class ActivityController {
    ...
    public Result getDetailList(HttpServletRequest request,
        ...
        String xkCode = AuthContextHolder.getXkCode(request);
        List<CourseSelectable> courseSelectableList = activityService.getDetailList(xkCode, kindId);
     ...
     */
    @PostMapping("/select/{courseSelectableId}")
    public Result select(HttpServletRequest request,
        ...
        return activityService.select(courseSelectableId, Long.valueOf(studentId), xkCode);
    }
